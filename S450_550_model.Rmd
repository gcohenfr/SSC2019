...
- **STAT450: Case Studies in Statistics**
  ...
  - statistical & computational & communication skills
...
- from collaborators
- from agencies and units (inside and outside UBC)
...
- to build collaborative relationships with peers and researchers
...
- Probably not, but it's difficult to get additional resources
...
- undergraduate students are in-charge of most of the work 
---
...
- can be easily transferred to the client at the end of the term

### Both classes meet regularly throughout the term
---
...
- Reports are drafted using R Markdown reports (mandatory for the 1st report)
...
---
# Acknowledgements
- Craig Burkett, Ed Kroc, Estella Qi, Dr. Sara Mostafavi 
